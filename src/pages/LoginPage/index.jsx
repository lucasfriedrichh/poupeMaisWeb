...
import "./style.css"
import logo from '../../images/logo1-removebg-preview.png'; // Importando a imagem do logo
      ...
      <MDBRow>
        <MDBCol md='6' className='text-center text-md-start d-flex flex-column justify-content-center'>
          <img
            ...
            style={{ width: '20%' }} // Reduzindo o tamanho da imagem em 20%
          />
          <h1 className="my-8 display-3 fw-bold ls-tight px-3" style={{ color: 'hsl(218, 81%, 95%)' }}>
            PoupeMais
            <br />
            <span style={{ color: 'hsl(218, 81%, 75%)' }}>Cresça seu dinheiro, alcance seus objetivos</span>
          </h1>
